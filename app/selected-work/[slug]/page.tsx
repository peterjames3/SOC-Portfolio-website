...
import {
  getAllSelectedWorkSlugs,
  getSelectedWorkBySlug,
} from "@/app/lib/selectedWorks";
...
export async function generateMetadata({
  ...
  return {
    title: `${work.frontmatter.title} | SEC.OPS`,
...
export default async function SelectedWorkPage({
  ...
  return (
    <>
      {/* Header */}
      <header className="fixed top-0 left-0 right-0 z-50 h-[72px] flex items-center bg-[rgba(13,10,9,0.9)] backdrop-blur-xl border-b border-[rgba(42,32,28,0.5)]">
        <div className="max-w-[1280px] mx-auto w-full px-6 md:px-12 lg:px-16 flex items-center justify-between">
          ...
          <GhostButton href="/#work">Back to My Work</GhostButton>
        </div>
      </header>
      ...
      <main className="pt-[72px]">
        ...
        <section className="relative bg-surface border-b border-border">
          <div className="max-w-[1000px] mx-auto px-6 md:px-12 lg:px-16 py-12 md:py-16">
            ...
            <p className="font-body text-lg text-text-secondary leading-relaxed max-w-[700px] mb-6">
        ...
        <section className="py-12 md:py-16">
          <div className="max-w-[800px] mx-auto px-6 md:px-12 lg:px-16">
            ...
            <div className="mt-16 pt-8 border-t border-border">
              <GhostButton href="/selected-work">← Selected Work</GhostButton>
            </div>
          </div>
        </section>
      </main>
